          ...
          <Grid container spacing={3} style={{ padding: 20 }}>
            {user && user.name && (
              <Grid item className={classes.hideOnSmall}>
                <Typography className={classes.bannerTitle}>Nombre</Typography>
            ...
            <Grid item>
              <Typography className={classes.bannerTitle}>Entradas</Typography>
              {selectedSeats > 0 ? (
                <Typography className={classes.bannerContent}>
                  {selectedSeats} entradas
                </Typography>
              ) : (
            ...
            <Grid item>
              <Typography className={classes.bannerTitle}>Precio</Typography>
              <Typography className={classes.bannerContent}>
